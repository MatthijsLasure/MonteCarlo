...
MODULE lib
    ...
    SUBROUTINE HELP
        ...
        WRITE (*,"(A)") "Use: ./boxbin [FLAGS]                                               "
        WRITE (*,"(A)") "                                                                    "
        WRITE (*,"(A)") "-b <file> / --binary <file>                                         "
        WRITE (*,"(A)") "Input box file, in binary form.                                     "
        WRITE (*,"(A)") "                                                                    "
        WRITE (*,"(A)") "-t <file> / --text <file>                                           "
        WRITE (*,"(A)") "Input box file, in text form.                                       "
        WRITE (*,"(A)") "                                                                    "
        WRITE (*,"(A)") "-d <file> / --DMSO <file>                                           "
        WRITE (*,"(A)") "DMSO file, in text form. Will use internal coordinates if omitted.  "
        WRITE (*,"(A)") "                                                                    "
        WRITE (*,"(A)") "-o <file> / --output <file>                                         "
        WRITE (*,"(A)") "Output file, in opposite form of the input file.                    "
        WRITE (*,"(A)") "                                                                    "
        WRITE (*,"(A)") "-q / --silent                                                       "
        WRITE (*,"(A)") "Do not print the data.                                              "
